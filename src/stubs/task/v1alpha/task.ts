...
export interface ListTasksResponse {
   ...
   *
   * @generated from protobuf field: repeated task.v1alpha.Task task = 1;
   */
  task: Task[];
  /**
...
class Task$Type extends MessageType<Task> {
  ...
  create(value?: PartialMessage<Task>): Task {
    const message = { id: 0, name: '', dueDate: '', done: false };
...
class ListTasksResponse$Type extends MessageType<ListTasksResponse> {
  ...
  create(value?: PartialMessage<ListTasksResponse>): ListTasksResponse {
    const message = { task: [], nextPageToken: '' };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
    });
  ...
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      const [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated task.v1alpha.Task task */ 1:
          message.task.push(
  ...
  internalBinaryWrite(
    ...
    /* repeated task.v1alpha.Task task = 1; */
    for (let i = 0; i < message.task.length; i++)
